...
public class XMLSerializer {
   ...
   /** the name for an JSONArray's elem Element */
   ...
   /**
    * Adds a namespace declaration to the root elem.
    *
   ...
   /**
    * Adds a namespace declaration to an elem.<br>
    * If the elementName param is null or blank, the namespace declaration will
    * be added to the root elem.
    *
    * @param prefix namespace prefix
    * @param uri namespace uri
    * @param elementName name of target elem
    */
   ...
   /**
    * Removes all namespace declarations from an elem.<br>
    * If the elementName param is null or blank, the declarations will be
    * removed from the root elem.
    *
    * @param elementName name of target elem
    */
   ...
   /**
    * Returns the name used for the root elem.
    */
   ...
   /**
    * Removes a namespace from the root elem.
    *
    * @param prefix namespace prefix
    */
   ...
   /**
    * Removes a namespace from the root elem.<br>
   ...
   /**
    * Sets the namespace declaration to the root elem.<br>
    ...
    * blank, the namespace declaration will be added to the root elem.
    *
    * @param prefix namespace prefix
    * @param uri namespace uri
    * @param elementName name of target elem
   ...
   /**
    * Sets the name used for the root elem.
    */
...
//            return true;
   ...
   private JSON processObjectElement( Element element, String defaultType ) {
      ...
      for( int i = 0; i < attrCount; i++ ){
         ...
         /*去掉转json后的attribute name前面带的@符号
   ...
   private void setValue( JSONObject jsonObject, Element element, String defaultType ) {
      ...
      if( hasNamespaces( element ) && !skipNamespaces ){
         ...
         if( isFunction( element ) ){
            ...
            setOrAccumulate( jsonObject, key, simplifyValue( jsonObject, processElement( elem,
                  type ) ) );
            return;
         }*/
      }
